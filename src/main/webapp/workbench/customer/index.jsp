				...
				<div class="modal-body">
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<input type="text" class="form-control" id="edit-customerName" value="阿里巴巴">
							</div>
						</div>
                        ...
                        <div style="position: relative;top: 20px;">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10" style="width: 81%;">
                                    <textarea class="form-control" rows="1" id="create-address">浙江省杭州市余杭区</textarea>
                                </div>
                            </div>
                        </div>
					</form>
			...
			<div style="position: relative;top: 10px;">
				<table class="table table-hover">
					...
					<tbody>
						<tr>
							<td><input type="checkbox" /></td>
							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='detail.jsp';">阿里巴巴</a></td>
							<td>zhangsan</td>
							<td>010-84846003</td>
