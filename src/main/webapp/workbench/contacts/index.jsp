					...
					<form class="form-horizontal" role="form">
                        ...
                        <div style="position: relative;top: 20px;">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10" style="width: 81%;">
                                    <textarea class="form-control" rows="1" id="edit-address1">浙江省杭州市余杭区</textarea>
                                </div>
                            </div>
                        </div>
					</form>
				...
				<div class="modal-body">
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<input type="text" class="form-control" id="edit-customerName" placeholder="支持自动补全，输入客户不存在则新建" value="阿里巴巴">
							</div>
						</div>
                        ...
                        <div style="position: relative;top: 20px;">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10" style="width: 81%;">
                                    <textarea class="form-control" rows="1" id="edit-address2">浙江省杭州市余杭区</textarea>
                                </div>
                            </div>
                        </div>
					</form>
